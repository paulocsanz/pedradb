...
/-- [pedra_aeneas_ae_kernel::ae_prev_log_ok]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 37:0-50:1
    Visibility: public -/
def ae_prev_log_ok
...
/-- [pedra_aeneas_ae_kernel::AeEntryAction]
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 54:0-63:1
    Visibility: public -/
@[discriminant isize]
...
/-- [pedra_aeneas_ae_kernel::{impl core::fmt::Debug for pedra_aeneas_ae_kernel::AeEntryAction}::fmt]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 53:9-53:14
    Visibility: public -/
...
/-- [pedra_aeneas_ae_kernel::{impl core::clone::Clone for pedra_aeneas_ae_kernel::AeEntryAction}::clone]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 53:16-53:21
    Visibility: public -/
...
/-- Trait implementation: [pedra_aeneas_ae_kernel::{impl core::marker::Copy for pedra_aeneas_ae_kernel::AeEntryAction}]
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 53:23-53:27 -/
@[reducible]
...
/-- Trait implementation: [pedra_aeneas_ae_kernel::{impl core::marker::StructuralPartialEq for pedra_aeneas_ae_kernel::AeEntryAction}]
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 53:29-53:38 -/
@[reducible]
...
/-- [pedra_aeneas_ae_kernel::{impl core::cmp::Eq for pedra_aeneas_ae_kernel::AeEntryAction}::assert_fields_are_eq]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 53:40-53:42
    Visibility: public -/
...
/-- [pedra_aeneas_ae_kernel::ae_entry_action]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 79:0-106:1
    Visibility: public -/
def ae_entry_action
...
/-- [pedra_aeneas_ae_kernel::ae_f16_safe]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 110:0-139:1
    Visibility: public -/
def ae_f16_safe
  (entry_index : Std.U64) (entry_term : Std.U64)
  (existing_term : Option Std.U64) (commit_index : Std.U64)
...
/-- [pedra_aeneas_ae_kernel::ae_f16_safe_as_is]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 144:0-153:1
    Visibility: public -/
...
/-- [pedra_aeneas_ae_kernel::ae_ack_success]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 159:0-161:1
    Visibility: public -/
...
/-- [pedra_aeneas_ae_kernel::ae_ack_success_as_is]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 165:0-167:1
    Visibility: public -/
...
/-- [pedra_aeneas_ae_kernel::ae_entry_action_as_is_rewrite_committed]:
    Source: '../../../crates/pedradb-raft/src/ae_kernel.rs', lines 172:0-191:1
    Visibility: public -/
