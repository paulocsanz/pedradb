...
- Charon `0.1.232` + Aeneas `daa85d7` → `out/lean/VoteKernel.lean`. Pairs `durable_term` and `grant_persist` are single_artifact: production file is the Verus term (`vote` keeps its twin).
