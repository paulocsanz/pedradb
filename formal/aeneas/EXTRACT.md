...
| `fail_closed` | `fail_closed.rs` | `parse_error_writes_status_true` / `reject_transfer_encoding_true` / `present_bad_int_is_error_true` (`--start-from` F102 + Iterator-free F104/F105/F157/F158; Expect/header-break stay `str/pattern` / Iterator) |
