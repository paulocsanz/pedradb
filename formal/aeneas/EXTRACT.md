...
- Charon `0.1.232` + Aeneas `daa85d7` → `out/lean/VoteKernel.lean`. Pair `durable_term` is single_artifact: production file is the Verus term (`vote` / `grant_persist` keep twins).
