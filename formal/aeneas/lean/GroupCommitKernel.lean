...
/-- [pedra_aeneas_group_commit_kernel::occ_conflict]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 196:0-198:1
    Visibility: public -/
def occ_conflict
...
/-- [pedra_aeneas_group_commit_kernel::OccRead]
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 204:0-210:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::{impl core::fmt::Debug for pedra_aeneas_group_commit_kernel::OccRead}::fmt]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 203:9-203:14
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::{impl core::clone::Clone for pedra_aeneas_group_commit_kernel::OccRead}::clone]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 203:16-203:21
    Visibility: public -/
...
/-- Trait implementation: [pedra_aeneas_group_commit_kernel::{impl core::marker::Copy for pedra_aeneas_group_commit_kernel::OccRead}]
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 203:23-203:27 -/
@[reducible]
...
/-- Trait implementation: [pedra_aeneas_group_commit_kernel::{impl core::marker::StructuralPartialEq for pedra_aeneas_group_commit_kernel::OccRead}]
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 203:29-203:38 -/
@[reducible]
...
/-- [pedra_aeneas_group_commit_kernel::{impl core::cmp::Eq for pedra_aeneas_group_commit_kernel::OccRead}::assert_fields_are_eq]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 203:40-203:42
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::group_validate]: loop body 0:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 221:4-228:5
    Visibility: public -/
@[rust_loop_body]
...
/-- [pedra_aeneas_group_commit_kernel::group_validate]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 218:0-230:1
    Visibility: public -/
def group_validate
...
/-- [pedra_aeneas_group_commit_kernel::OccMemberFate]
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 236:0-243:1
    Visibility: public -/
@[discriminant isize]
...
/-- [pedra_aeneas_group_commit_kernel::{impl core::fmt::Debug for pedra_aeneas_group_commit_kernel::OccMemberFate}::fmt]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 235:9-235:14
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::{impl core::clone::Clone for pedra_aeneas_group_commit_kernel::OccMemberFate}::clone]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 235:16-235:21
    Visibility: public -/
...
/-- Trait implementation: [pedra_aeneas_group_commit_kernel::{impl core::marker::Copy for pedra_aeneas_group_commit_kernel::OccMemberFate}]
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 235:23-235:27 -/
@[reducible]
...
/-- Trait implementation: [pedra_aeneas_group_commit_kernel::{impl core::marker::StructuralPartialEq for pedra_aeneas_group_commit_kernel::OccMemberFate}]
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 235:29-235:38 -/
@[reducible]
...
/-- [pedra_aeneas_group_commit_kernel::{impl core::cmp::Eq for pedra_aeneas_group_commit_kernel::OccMemberFate}::assert_fields_are_eq]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 235:40-235:42
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::occ_member_fate]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 248:0-250:1
    Visibility: public -/
def occ_member_fate
...
/-- [pedra_aeneas_group_commit_kernel::occ_member_fate_as_is]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 255:0-257:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::occ_batch_plan]: loop body 0:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 276:4-284:5
    Visibility: public -/
@[rust_loop_body]
...
/-- [pedra_aeneas_group_commit_kernel::occ_batch_plan]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 264:0-286:1
    Visibility: public -/
def occ_batch_plan
  (too_old : Slice Bool) (reads : Slice OccRead) (last_seq : Std.U64) :
  Result (alloc.vec.Vec OccMemberFate)
...
/-- [pedra_aeneas_group_commit_kernel::occ_batch_plan_as_is]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 291:0-309:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::fence_publish_seq]: loop body 0:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 318:4-323:5
    Visibility: public -/
@[rust_loop_body]
...
/-- [pedra_aeneas_group_commit_kernel::fence_publish_seq]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 315:0-325:1
    Visibility: public -/
@[reducible]
...
/-- [pedra_aeneas_group_commit_kernel::fence_publish_seq_as_is]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 331:0-337:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::occ_conflict_as_is_serialized]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 347:0-359:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::forall_schedules_admitted]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 365:0-367:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::forall_schedules_admitted_as_is]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 372:0-374:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::may_publish_group]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 410:0-412:1
    Visibility: public -/
def may_publish_group (wal_io_ok : Bool) : Result Bool := do
  ok wal_io_ok

/-- [pedra_aeneas_group_commit_kernel::rwlock_client_may_mutate]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 419:0-421:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::stacked_fsync_liars_admitted]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 486:0-488:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::stacked_fsync_liars_admitted_as_is]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 493:0-495:1
    Visibility: public -/
...
/-- [pedra_aeneas_group_commit_kernel::fsync_lie_closes_tcg_guest]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 501:0-503:1
    Visibility: public -/
def fsync_lie_closes_tcg_guest : Result Bool := do
  ok false

/-- [pedra_aeneas_group_commit_kernel::fsync_lie_closes_tcg_guest_as_is]:
    Source: '../../../crates/pedradb-core/src/group_commit_kernel.rs', lines 508:0-510:1
    Visibility: public -/
