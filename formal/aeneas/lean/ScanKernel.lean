...
/-- [pedra_aeneas_scan_kernel::scan_kernel::tombstone_reaches_window_as_is]:
    Source: 'src/../../../../crates/pedradb-core/src/sst/scan_kernel.rs', lines 49:0-56:1
    Visibility: public -/
...
/-- [pedra_aeneas_scan_kernel::scan_kernel::point_bounds_overlap]:
    Source: 'src/../../../../crates/pedradb-core/src/sst/scan_kernel.rs', lines 60:0-80:1
    Visibility: public -/
...
def scan_kernel.point_bounds_overlap_as_is
  ...
  let b ←
    match end1 with
    | core.ops.range.Bound.Included _ => ok false
    | core.ops.range.Bound.Excluded _ => ok false
    | core.ops.range.Bound.Unbounded => ok true
  if b
  then ok false
