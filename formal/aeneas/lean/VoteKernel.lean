...
/-- [pedra_aeneas_vote_kernel::VoteInputs]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 32:0-49:1
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::{impl core::fmt::Debug for pedra_aeneas_vote_kernel::VoteInputs}::fmt]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 31:9-31:14
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::{impl core::clone::Clone for pedra_aeneas_vote_kernel::VoteInputs}::clone]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 31:16-31:21
    Visibility: public -/
...
/-- Trait implementation: [pedra_aeneas_vote_kernel::{impl core::marker::Copy for pedra_aeneas_vote_kernel::VoteInputs}]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 31:23-31:27 -/
@[reducible]
...
/-- Trait implementation: [pedra_aeneas_vote_kernel::{impl core::marker::StructuralPartialEq for pedra_aeneas_vote_kernel::VoteInputs}]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 31:29-31:38 -/
@[reducible]
...
/-- [pedra_aeneas_vote_kernel::{impl core::cmp::Eq for pedra_aeneas_vote_kernel::VoteInputs}::assert_fields_are_eq]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 31:40-31:42
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::VoteDecision]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 53:0-58:1
    Visibility: public -/
@[discriminant isize]
...
/-- [pedra_aeneas_vote_kernel::{impl core::fmt::Debug for pedra_aeneas_vote_kernel::VoteDecision}::fmt]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 52:9-52:14
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::{impl core::clone::Clone for pedra_aeneas_vote_kernel::VoteDecision}::clone]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 52:16-52:21
    Visibility: public -/
...
/-- Trait implementation: [pedra_aeneas_vote_kernel::{impl core::marker::Copy for pedra_aeneas_vote_kernel::VoteDecision}]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 52:23-52:27 -/
@[reducible]
...
/-- Trait implementation: [pedra_aeneas_vote_kernel::{impl core::marker::StructuralPartialEq for pedra_aeneas_vote_kernel::VoteDecision}]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 52:29-52:38 -/
@[reducible]
...
/-- [pedra_aeneas_vote_kernel::{impl core::cmp::Eq for pedra_aeneas_vote_kernel::VoteDecision}::assert_fields_are_eq]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 52:40-52:42
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::can_vote]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 62:0-69:1
    Visibility: public -/
def can_vote
...
/-- [pedra_aeneas_vote_kernel::log_up_to_date]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 73:0-81:1
    Visibility: public -/
def log_up_to_date
...
/-- [pedra_aeneas_vote_kernel::vote_decision]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 106:0-122:1
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::vote_decision_spec]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 126:0-139:1
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::vote_decision_as_is_ignore_log_and_vote]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 144:0-150:1
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::PersistOutcome]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 154:0-159:1
    Visibility: public -/
@[discriminant isize]
...
/-- [pedra_aeneas_vote_kernel::{impl core::fmt::Debug for pedra_aeneas_vote_kernel::PersistOutcome}::fmt]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 153:9-153:14
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::{impl core::clone::Clone for pedra_aeneas_vote_kernel::PersistOutcome}::clone]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 153:16-153:21
    Visibility: public -/
...
/-- Trait implementation: [pedra_aeneas_vote_kernel::{impl core::marker::Copy for pedra_aeneas_vote_kernel::PersistOutcome}]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 153:23-153:27 -/
@[reducible]
...
/-- Trait implementation: [pedra_aeneas_vote_kernel::{impl core::marker::StructuralPartialEq for pedra_aeneas_vote_kernel::PersistOutcome}]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 153:29-153:38 -/
@[reducible]
...
/-- [pedra_aeneas_vote_kernel::{impl core::cmp::Eq for pedra_aeneas_vote_kernel::PersistOutcome}::assert_fields_are_eq]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 153:40-153:42
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::grant_after_persist]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 166:0-173:1
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::grant_after_persist_as_is]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 177:0-180:1
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::DurableTerm]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 184:0-192:1
    Visibility: public -/
@[discriminant isize]
...
/-- [pedra_aeneas_vote_kernel::{impl core::fmt::Debug for pedra_aeneas_vote_kernel::DurableTerm}::fmt]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 183:9-183:14
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::{impl core::clone::Clone for pedra_aeneas_vote_kernel::DurableTerm}::clone]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 183:16-183:21
    Visibility: public -/
...
/-- Trait implementation: [pedra_aeneas_vote_kernel::{impl core::marker::Copy for pedra_aeneas_vote_kernel::DurableTerm}]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 183:23-183:27 -/
@[reducible]
...
/-- Trait implementation: [pedra_aeneas_vote_kernel::{impl core::marker::StructuralPartialEq for pedra_aeneas_vote_kernel::DurableTerm}]
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 183:29-183:38 -/
@[reducible]
...
/-- [pedra_aeneas_vote_kernel::{impl core::cmp::Eq for pedra_aeneas_vote_kernel::DurableTerm}::assert_fields_are_eq]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 183:40-183:42
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::durable_term_if_newer]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 197:0-209:1
    Visibility: public -/
...
/-- [pedra_aeneas_vote_kernel::durable_term_if_newer_as_is]:
    Source: '../../../crates/pedradb-raft/src/vote_kernel.rs', lines 214:0-225:1
    Visibility: public -/
