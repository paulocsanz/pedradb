...
/-- [pedra_aeneas_form_kernel::form_plus_byte_as_is]:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 76:0-78:1
    Visibility: public -/
def form_plus_byte_as_is (b : Std.U8) : Result Std.U8 := do
  ok b

/-- [pedra_aeneas_form_kernel::plus_before_percent]:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 83:0-85:1
    Visibility: public -/
def plus_before_percent : Result Bool := do
  ok true

/-- [pedra_aeneas_form_kernel::plus_before_percent_as_is]:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 91:0-93:1
    Visibility: public -/
def plus_before_percent_as_is : Result Bool := do
  ok false

/-- [pedra_aeneas_form_kernel::from_hex]:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 98:0-105:1
    Visibility: public -/
...
/-- [pedra_aeneas_form_kernel::from_hex_as_is]:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 111:0-113:1
    Visibility: public -/
def from_hex_as_is (c : Std.U8) : Result (Option Std.U8) := do
  if 48#u8 <= c
  then if c <= 57#u8
       then let i ← c - 48#u8
            ok (some i)
...
/-- [pedra_aeneas_form_kernel::form_decode]: loop body 0:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 1:0-137:5
    Visibility: public -/
@[rust_loop_body]
...
/-- [pedra_aeneas_form_kernel::form_decode]:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 118:0-139:1
    Visibility: public -/
...
/-- [pedra_aeneas_form_kernel::query_values_conflict::closure]
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 147:46-147:62 -/
@[reducible]
...
/-- [pedra_aeneas_form_kernel::query_values_conflict]:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 144:0-149:1
    Visibility: public -/
@[rust_loop_body]
...
/-- [pedra_aeneas_form_kernel::query_part_is_bare_name_as_is]:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 182:0-184:1
    Visibility: public -/
...
/-- [pedra_aeneas_form_kernel::form_decode_as_is]: loop body 0:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 1:0-203:5
    Visibility: public -/
@[rust_loop_body]
...
/-- [pedra_aeneas_form_kernel::form_decode_as_is]:
    Source: '../../../crates/pedradb-http/src/form_kernel.rs', lines 189:0-205:1
    Visibility: public -/
