...
| commit_raft | `pedradb-raft/src/commit_kernel.rs` | close | `pedradb-raft/lib.rs`, `pedradb-raft/net.rs` |
...
| apply_step | `pedradb-raft/src/apply_kernel.rs` | close | `pedradb-raft/lib.rs` |
