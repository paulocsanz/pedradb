...
- [ ] **P1.3** `deps_mvcc_latest` e `deps_scan` ≥ 0.5 × Rocks FF da run — status: `todo` (cache 8192 + count sem value; MVCC 2.3×, scan 4.8×)
...
| P1.3 | p1 | MVCC+scan ≥ 0.5 vs FF | todo | cache 8192: MVCC 105k vs 243k = 2.3×; scan 54k / 14 µs = 4.8× | 2026-08-16 |
