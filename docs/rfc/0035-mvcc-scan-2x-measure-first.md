...
- [ ] **P1.3** `deps_mvcc_latest` e `deps_scan` ≥ 0.5 × Rocks FF da run — status: `todo` (LRU hit O(1); remesura no ruído de 2.3× / 4.8×)
...
| P1.3 | p1 | MVCC+scan ≥ 0.5 vs FF | todo | LRU O(1): MVCC 101k vs 244k = 2.4×; scan 52k / 13 µs = 5.0× | 2026-08-16 |
