...
- [ ] **P1.3** `deps_mvcc_latest` e `deps_scan` ≥ 0.5 × Rocks FF da run — status: `todo` (índice SST em log; MVCC 2.8×, scan 5.5×)
...
| P1.3 | p1 | MVCC+scan ≥ 0.5 vs FF | todo | índice log: MVCC 90k vs 249k = 2.8×; scan 52k / 14 µs = 5.5× | 2026-08-16 |
