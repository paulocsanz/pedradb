...
| P2.3 | p2 | Alvo trampolim cap≤100 / floor_atom≥8 | doing | 13/29 caps pagos (117; …P2.3-12 `lease` — lease viva só se zero ou relógio abaixo do expiry, F7/F56; P2.3-13 `ae_ack` — ack AE ok só se log limpo OU sujo-e-persistido, F48), atoms 14/8; falta cap 117→≤100 | 2026-09-10 |
