...
| P2.3 | p2 | Alvo trampolim cap≤100 / floor_atom≥8 | doing | 28/29 caps pagos (102; …P2.3-27 `encode_cf_key` — encoding devolve a chave nua com encoding efetivo vazio; senão cadeia planejada por capacidade: bytes do cf, um 0 separador, a chave, cada passo ok, RFC-0150 P0; P2.3-28 `infer_sst_cf` — SST tagueado com a família dos bounds exatamente quando os dois compartilham uma família; bound único toma a família dele; sem bounds tag vazia (mista/legacy) — nunca tag que minta sobre conteúdo misto, RFC-0150 P0), atoms 29/8; falta cap 102→≤100 — fila cf esgotada, déficit 2 além | 2026-09-10 |
