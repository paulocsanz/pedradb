...
| P2.3 | p2 | Alvo trampolim cap≤100 / floor_atom≥8 | doing | 21/29 caps pagos (109; …P2.3-20 `vlog_recover` — recovery recusa só com swing commitado e nenhum arquivo em disco, F51/G-swing; P2.3-21 `ae_entry` — conflito trunca só acima do commit, nunca reescreve commitado, F16), atoms 22/8; falta cap 109→≤100 | 2026-09-10 |
