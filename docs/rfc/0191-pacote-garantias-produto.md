...
| P2.3 | p2 | Alvo trampolim cap≤100 / floor_atom≥8 | doing | 8/29 caps pagos (122; …P2.3-7 `revert_clears_status`, P2.3-8 `durable_term` — termo sobe durável só com termo novo E persist Ok; persist falho restaura o termo velho), **atoms 9/8 — meta atom fechada**; falta cap 122→≤100 | 2026-09-10 |
