...
| P2.3 | p2 | Alvo trampolim cap≤100 / floor_atom≥8 | doing | 18/29 caps pagos (112; …P2.3-17 `manifest_recover` — recovery recusa só Corrupt ou Inventory-com-SST-faltando, F196/G8; P2.3-18 `compact_decision` — reescrita GC do nível máximo só sem nível com arquivos E gc pedido E arquivos no máximo, F177/F20), atoms 19/8; falta cap 112→≤100 | 2026-09-10 |
