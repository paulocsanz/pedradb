...
| P2.3 | p2 | Alvo trampolim cap≤100 / floor_atom≥8 | doing | 3/29 caps pagos (127; P1.5 `si_hist_repair`, P2.3-2 `apply_put_plan`, P2.3-3 `hist_load_fate` — merge de réplica corrompida nunca evita a cópia boa), atoms 4/8 | 2026-09-10 |
