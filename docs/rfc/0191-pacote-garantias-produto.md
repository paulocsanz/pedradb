...
| P2.3 | p2 | Alvo trampolim cap≤100 / floor_atom≥8 | doing | 14/29 caps pagos (116; …P2.3-13 `ae_ack` — ack AE ok só se log limpo OU sujo-e-persistido, F48; P2.3-14 `sched_plant_joint` — planta joint-commit visível só no mundo opt-in E omitida no default, RFC-0068), atoms 15/8; falta cap 116→≤100 | 2026-09-10 |
