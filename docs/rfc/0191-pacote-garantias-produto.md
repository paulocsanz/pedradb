...
| P2.3 | p2 | Alvo trampolim cap≤100 / floor_atom≥8 | doing | 9/29 caps pagos (121; …P2.3-8 `durable_term` — termo sobe durável só com termo novo E persist Ok; persist falho restaura o termo velho; P2.3-9 `queued_leave_finish` — leave pendente termina só fora do log ou já commitado, RFC-0122/0123), atoms 10/8; falta cap 121→≤100 | 2026-09-10 |
