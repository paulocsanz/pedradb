...
9. **P2.2** raft/dcs/l28/scale/bloom/probe ×21: `apply_step`,
   ...
   status: `todo`
   (19/21: `bloom_header_fate_iff`, `insert_fate_iff`,
   ...
   `recover_last_applied_fate_iff` `apply_advance_fate_iff` `ae_f16_safe_fate_iff` `dcs_apply_should_advance_result_fate_iff` e `dcs_apply_should_advance_fate_iff` feitos 2026-09-13)
