...
**Status:** in-progress (P0.1/P0.3/P0.4 done; P0.2/P2.1 wiped-pre-commit — forense 2026-09-11; P1.1/P1.2 re-bloqueados)
**Updated:** 2026-09-14
**ID:** 0192
...
- [x] **P0.3** `pedra scale-model write` imprime `write_cycle_forecast` (mesmo kernel; AS-IS = `lock_hold`) — status: `done` (2026-09-14: `--fixture linux-quiet` = `write_cycle_forecast.render()`; `--keys/--ram` = `linux_overwrite_mc4_hat` da curva 0197, QPS Linux estático, hat nunca cartaz. Testes `rfc0192_pedra_scale_model_write_prints_kernel` + `linux_overwrite_mc4_hat_cli_equals_kernel`)
...
| P0.3 | p0 | CLI write forecast | done | `scale-model write` = kernel render (fixture + linux hat) | 2026-09-14 |
