...
- [x] **P0.3** RFC-0220 P0.5: `manifest_publish_plan` × `changelog_durable_commit_fate` — status: done (`ComposeWriter.lean`: `writer_publish_chain_iff` / `durable_and_counted_publishes` / `not_durable_holds_fail_closed`; lake 2× verde; m2 41→42)
