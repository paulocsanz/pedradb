...
Alvo de produto passou a **RFC-0041**: ≥ **2×** Rocks default. streamsst **3/16** (C/E/MVCC). apply_mc4 **0.74** — stream L0 write did not remove the 64 MiB lz4/rotate tail. FLOOR off.
