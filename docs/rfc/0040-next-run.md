...
Alvo de produto passou a **RFC-0041**: ≥ **2×** Rocks default. okidle **0/16** (idle = last Ok). scansst still the best 1/16. FLOOR off. 1c A still 1/`fdatasync` (p50 23.9 µs). P1.2 1c 2× is above `1/t_fd` under G1 — alvo/peer unchanged.
