...
Alvo de produto passou a **RFC-0041**: ≥ **2×** Rocks default. encode-off-lock **rejected** (encoff 1.7 k, enc1hop 654–1841). parkfold2 still best (scan 2.21, E 2.06). FLOOR off. 1c A still 1/`fdatasync`. P1.2 1c 2× is above `1/t_fd` under G1 — alvo/peer unchanged.
