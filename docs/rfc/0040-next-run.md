...
Alvo de produto passou a **RFC-0041**: ≥ **2×** Rocks default. inval **3/16** (E 2.20, MVCC 2.97, apply_mc4 2.05 vs weak Rocks). Scan med 1.52. FLOOR off. 1c A still 1/`fdatasync`. P1.2 1c 2× is above `1/t_fd` under G1 — alvo/peer unchanged.
