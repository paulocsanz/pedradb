...
Alvo de produto passou a **RFC-0041**: ≥ **2×** Rocks default em todas as shapes. P0.2 **done** — 0/16 ≥ 2.0. idle64 **3/16** (C/E/scan) ([idle64](../findings/rfc0041-p11/idle64/README.md)). P1.1 **doing** — apply still pays a 64 MiB SST fsync; skip-imm-drain rejected (apply_mc4 ~280).
