...
Alvo de produto passou a **RFC-0041**: ≥ **2×** Rocks default. foldidle **1/16** (E **2.29**; apply_mc4 1.25). Park pins on drain; fold off-lock when idle. Absorb-on-write-lock rejected (apply_mc4 ~1 k). FLOOR off.
