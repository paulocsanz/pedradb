...
Alvo de produto passou a **RFC-0041**: ≥ **2×** Rocks default em todas as shapes. P0.2 **done** — 0/16 ≥ 2.0 ([p02](../findings/rfc0041-p02/README.md)). Próximo: 0041 P1.1 apply/raftlog MC.
