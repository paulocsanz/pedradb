...
Alvo de produto passou a **RFC-0041**: ≥ **2×** Rocks default. scansst **1/16** (MVCC **2.58**; scan **1.15**). fat20/fat20b rejected (1 ms idle / 20 µs fat hold). FLOOR off. 1c A still 1/`fdatasync` (p50 23.3 µs).
