...
Alvo de produto passou a **RFC-0041**: ≥ **2×** Rocks default em todas as shapes. idle64 **3/16** (C/E/scan). P1.1 **doing** — L0 write skips SST `fdatasync` until WAL rotate (G1: WAL still covers those keys).
