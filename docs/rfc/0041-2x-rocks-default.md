...
- [ ] **P1.1** `deps_apply_batch_mc4` e `deps_raftlog_mc4` ≥ 2.0 vs default da run — status: `doing` (inval apply_mc4 **2.05** vs weak Rocks, Pedra 3.3 k < parkfold2 4.3 k; nowake/parkonly rejected)
...
| P1.1 | p1 | apply/raftlog MC ≥ 2× | doing | inval apply_mc4 2.05 (weak Rocks) | 2026-08-17 |
