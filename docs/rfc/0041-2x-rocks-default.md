...
- [ ] **P1.1** `deps_apply_batch_mc4` e `deps_raftlog_mc4` ≥ 2.0 vs default da run — status: `doing` (raftlog 16-op catch-up on again — skip only apply 64. Remesura 16-shape espera caixa quieta. parkfold2 still best official Pedra 4.3 k / raftlog_mc4 0.62)
...
| P1.1 | p1 | apply/raftlog MC ≥ 2× | doing | raftlog catch-up (skip only 64-op); remesura pending | 2026-08-17 |
