...
- [ ] **P1.1** `deps_apply_batch_mc4` e `deps_raftlog_mc4` ≥ 2.0 vs default da run — status: `doing` (MemTable unsorted tail: apply Ok = O(1) push, spill at 512 / stage / park. Adversarial 5/5. Remesura 16-shape espera caixa quieta. parkfold2 still best official Pedra 4.3 k)
