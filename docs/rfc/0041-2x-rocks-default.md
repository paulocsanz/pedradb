...
| P1.3 | p1 | apply/raftlog 1c ≥ 2× | doing | rearm7 quieta: raftlog 0,35× com **p50 em paridade (7,5 vs 6,9–8,5 µs)** — gap = stall APFS 8 MiB-extent no WAL (20–38 ms/perna); fix = pré-alocação WAL | 2026-08-23 |
