...
- [ ] **P1.1** `deps_apply_batch_mc4` e `deps_raftlog_mc4` ≥ 2.0 vs default da run — status: `doing` (late-join no group: absorve a fila antes do fd; **ainda < 2.0** — [p11](../../findings/rfc0041-p11/README.md))
...
| P1.1 | p1 | apply/raftlog MC ≥ 2× | doing | late-join; still <2.0 | 2026-08-17 |
