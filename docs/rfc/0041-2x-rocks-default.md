...
| P1.3 | p1 | apply/raftlog 1c ≥ 2× | doing | rearm8 quieta (wal-prealloc): raftlog 0,59× — **cauda na classe do peer** (stall APFS eliminado; era 0,35×); apply 2,10 med (2/3, r1 1,99); gap restante = submit-path 13–15 vs 7,6–8,0 µs/batch (core ~4 µs) | 2026-08-23 |
