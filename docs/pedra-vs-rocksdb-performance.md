...
- Código: `crates/pedradb-core/src/cache_kernel.rs` (CountCache, 3a722e7), `db.rs` (count_in_range, invalidate), `crates/rocksdb-compat/src/lib_kernel.rs` (auto_reclaim, d9abd6f)
