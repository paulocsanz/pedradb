...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). P1.1 **doing**: foldidle **1/16** E **2.29** apply_mc4 **1.25** ([foldidle](../findings/rfc0041-p11/foldidle/README.md)). Sem FLOOR. Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
