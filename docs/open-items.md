...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). P1.1 **doing**: scansst **1/16** MVCC **2.58** scan **1.15**. fat20/fat20b rejected. Sem FLOOR. Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
