...
**Shipped (perf parity P0):** [RFC-0025](rfc/0025-montanha-perf-parity-vs-peers.md) — `put_many` range-grouped batch, `StoreOpenOptions` / lab capacity open, bench A1b/A1c batch vs single.  
