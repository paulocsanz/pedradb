...
**Open (RFC-0031):** orçamento de paridade ≤10× do RocksDB por shape (floor = rocksdb_sync1/10 na tabela do RFC) — P0 CHANGELOG debounce inline (`PEDRA_CHANGELOG_INTERVAL`, sem thread), P1 iterador com janela bornada, gate `ROCKS_PARITY_RATIO_FLOOR=0.1` no lab quando P0 pousar. Ver [RFC-0031](rfc/0031-rocks-parity-10x-budget.md).
