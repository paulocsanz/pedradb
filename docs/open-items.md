...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). P1.1 **doing**: enc1hop encode-off-lock **rejected** (apply_mc4 654–1841). Best still parkfold2 (scan 2.21, E 2.06). 1c A/F 2× above `1/t_fd`; FLOOR off. Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
