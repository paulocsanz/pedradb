...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). P0.2 **done**: **0/16 ≥ 2.0**. P1.1 **doing**: retire2 **1/16** MVCC **3.08** apply_mc4 **1.45** ([retire2](../findings/rfc0041-p11/retire2/README.md)). Sem FLOOR. Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
