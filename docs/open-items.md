...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). P1.1 **doing**: inval **3/16** (E 2.20, MVCC 2.97, apply_mc4 2.05 vs weak Rocks). Scan med 1.52. nowake/parkonly rejected. 1c A/F 2× above `1/t_fd`; FLOOR off. Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
