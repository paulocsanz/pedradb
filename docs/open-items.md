...
**Open (RFC-0033):** P0 shipped. 2026-08-16 vs FF: MVCC **18×** (9.0k / 160k), scan **27×** (6.1k / 165k) — alvo 2× **não** atingido. `last_under_user_prefix` salta SST se a mem já tem a latest; scan não clona o bloco. Residual = L0 sobrepostos quando a key não está na mem. Ver [RFC-0033](rfc/0033-mvcc-scan-2x.md).
