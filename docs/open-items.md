...
**Open (RFC-0040):** `fdatasync` always-on **mais rápido que Rocks async** via amortizar o fd + uma cópia até o WAL. P0.2/P0.3 shipped (encode scratch + count sem Box). P1 = remesura MC vs async. Ver [RFC-0040](rfc/0040-fsync-always-beats-rocks-async.md).
