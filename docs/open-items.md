...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). P0.2 **done**: **0/16 ≥ 2.0** ([p02](../findings/rfc0041-p02/README.md)). P1.1 **doing**: buf4 **1/16** apply_mc4 **1.17** ([buf4](../findings/rfc0041-p11/buf4/README.md)); compact-while-busy rejected ([buf4c](../findings/rfc0041-p11/buf4c/README.md)). Sem FLOOR. Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
