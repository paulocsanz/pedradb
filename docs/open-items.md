...
**Shipped (perf parity P0+P1.2/P1.4):** [RFC-0025](rfc/0025-montanha-perf-parity-vs-peers.md) — `put_many`, lab open, batch benches; **incremental raft log** append (`log/e/*`+`log_hi`); layers prefer batch/TX.  
