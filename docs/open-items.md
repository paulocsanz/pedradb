...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). P1.1 **doing**: okidle **0/16** apply_mc4 1.13. scansst still 1/16 best. 1c A/F 2× above `1/t_fd` (p50 23.9 µs) under G1; FLOOR off. Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
