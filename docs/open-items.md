...
**Open (RFC-0035):** `PointCache` no `get`. MVCC **113k / 1.1 µs** vs FF 270k — **2.4×** (era 101k; 105k→101k foi ruído). Scan **59k / 13 µs** vs 246k — **4.2×**. **2× não** (P1.3). Residual = first-touch SST + 3 streams. Ver [RFC-0035](rfc/0035-mvcc-scan-2x-measure-first.md).
