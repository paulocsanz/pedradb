...
**Open (RFC-0040):** peer oficial = Rocks **default** (async). Pedra+fd tem de ganhar mesmo assim. P1.1+P1.2 done; apply MC ~0.9× default. **Próxima:** P2.1 scan / L0. Ver [p11](../findings/rfc0040-p11/README.md).
