...
**Open (RFC-0035):** BlockCache hit O(1). MVCC **101k / 1.3 µs** vs FF 244k — **2.4×**. Scan **52k / 13 µs** vs 260k — **5.0×** (ruído vs 4.8×). **2× não** (P1.3). Residual = get no fallback SST + 3 streams. Ver [RFC-0035](rfc/0035-mvcc-scan-2x-measure-first.md).
