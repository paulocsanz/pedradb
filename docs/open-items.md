...
**Open (RFC-0035):** scan emite 1 versão visível/user/camada. MVCC **51k / 1.3 µs** vs FF 228k — **4.4×**. Scan **8.0k / 117 µs** vs 229k — **29×** (era 44× / 131 µs). **2× não** (P1.3). Residual scan = setup+walk de 3 streams (~117 µs), não decode. Ver [RFC-0035](rfc/0035-mvcc-scan-2x-measure-first.md).
