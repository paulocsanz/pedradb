...
**Open (RFC-0035):** P0–P1.2 + corte SST newest-first/LRU shipped. MVCC **45k qps / p50 1.5 µs** vs Rocks FF 187k / 3.4 µs — **4.1×** (era 13×). Scan 6.2k / 131 µs, cache **95%** — o p50 já não é decode. **2× não** (P1.3). Residual MVCC = cauda 21% SST; scan = merge de 3 streams. Ver [RFC-0035](rfc/0035-mvcc-scan-2x-measure-first.md).
