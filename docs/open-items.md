...
**Open (RFC-0035):** fechar **≤2×** em MVCC + `deps_scan` vs FF **sem** afrouxar G1–G8. P0 = telemetria (SST tocados, cache, mem-hit vs SST, split de tempo) + finding ranqueado **antes** de patch/redesign. P1 só o gargalo #1 do finding. P2 redesign só com cliff medido. Ver [RFC-0035](rfc/0035-mvcc-scan-2x-measure-first.md).
