...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). P1.1 **doing**: parkfold2 **2/16** (scan 2.21, E 2.06, apply_mc4 1.69). 1c A/F 2× above `1/t_fd` under G1; FLOOR off. Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
