...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). P0.2 **done**: **0/16 ≥ 2.0** ([p02](../findings/rfc0041-p02/README.md)). P1.1 **doing**: MANIFEST `fsync` fora do write lock + skip catch-up em batch ≥16; apply_mc4 ainda < 2.0 ([p11](../findings/rfc0041-p11/README.md)). Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
