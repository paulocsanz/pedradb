...
**Open (RFC-0059):** bateria Linux/AMD (anti-1): **13/16 ≥2×** async same-class, **sem overindex** (unif ±1.5%, big −22%). Linux-only: `deps_apply_batch` 1.87/2.13/1.83 e `deps_raftlog` 0.79/0.91/1.47 reprovam (Mac passa) — diag fases em curso (linux-diag-2). SurrealDB v1.5.4 no shim `rocksdb` 0.21: kvs 62/62 (F183). Ver [RFC-0059](rfc/0059-substitution-anti-overindex-linux-gate.md).
