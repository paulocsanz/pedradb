...
**Open (RFC-0035):** índice SST em `partition_point`. MVCC **90k / 1.2 µs** vs FF 249k — **2.8×**. Scan **52k / 14 µs** vs 283k — **5.5×** (era 29× / 117 µs). **2× não** (P1.3). Residual = get no fallback SST + merge de 3 streams. Ver [RFC-0035](rfc/0035-mvcc-scan-2x-measure-first.md).
