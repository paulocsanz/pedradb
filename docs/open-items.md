...
**Open (RFC-0035):** P0+P1.1+P1.2 shipped. Mem-hit get explicado e cortado (encode 57 ns, copy 235 ns; MemTable borrowed lookup). MVCC **18.8k qps / p50 2.0 µs** vs Rocks FF 252k / 3.3 µs — **13×** no qps, p50 já mais rápido. **2× qps não**. Residual = **21% SST fallback** (p95 265 µs). Scan p50 ~139 µs, fora do corte P1.2. Ver [RFC-0035](rfc/0035-mvcc-scan-2x-measure-first.md).
