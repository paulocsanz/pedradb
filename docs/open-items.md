...
**Open (RFC-0041):** Pedra ≥ **2×** Rocks **default** em **todo** o harness (11 + MC4). Peer único `sync=false`. P0.2 **done**: **0/16 ≥ 2.0** ([p02](../findings/rfc0041-p02/README.md); apply_mc4 0.89, E 0.91, A 1c 0.056; `1/fd` ≈ 39 k). P0.3 não liga gate vazio. P1.1 = apply/raftlog MC. Ver [RFC-0041](rfc/0041-2x-rocks-default.md).
