...
**Open (RFC-0040):** P1.1 **done** — apply MC4 mediana **0.93×** Rocks async (fd always-on). Raftlog MC run1 1.57× (mediana 0.61). P1.2 = fechar 0.93→≥1; P2.1 = scan cauda L0. Ver [rfc0040-p11](../findings/rfc0040-p11/README.md).
