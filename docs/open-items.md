...
**Open (RFC-0040):** P1.1+P1.2 **done**. Apply MC ~0.9× async (group 1.55; catch-up 200 µs rejeitado). **Próxima:** P2.1 scan / L0. Ver [p11](../findings/rfc0040-p11/README.md) [p12](../findings/rfc0040-p12/README.md).
