...
**Open (RFC-0033):** fechar **MVCC latest** (124 qps vs floor 37k) e **deps_scan** (1.0k vs floor 6.5k). Causa: `scan_at_raw` materializa um `Vec` por L0 *antes* do `limit`. P0 = `last_under_prefix` + limit na coleta. Ver [RFC-0033](rfc/0033-mvcc-scan-2x.md).
