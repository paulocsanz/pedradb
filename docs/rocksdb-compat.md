...
| knobs (`set_*`) | ✅ classified | [`KNOB_INVENTORY`](../crates/rocksdb-compat/src/knobs_kernel.rs): Wired / Inert / NotSupported (G2) / SaferDivergent. `set_verify_checksums(false)` → `ErrorKind::NotSupported` |
