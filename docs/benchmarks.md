...
surreal, nebula, streaming, ceph, solana, arango, venice, oxigraph, rocksapi). `rocks-parity-compare` copies it onto each
...
# scale get_hit / lookup_100 always print (no COST_TRACE needed)
