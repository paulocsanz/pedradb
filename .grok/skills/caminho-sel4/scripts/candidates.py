...
def script_compose_board() -> None:
    ...
    print(
        "  leftover_next RFC-0179 Lean unfold disk_pressure_reclaim_plan AND compact_allowed_under_pressure; skip leftover is_empty factory; skip Montanha; named kernel not SA"
    )
