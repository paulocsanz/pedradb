...
| **overwrite_mc4 25M** | **U** | Linux 0.557× 3/3; Darwin 0180 ~1.00 mediana (named 0.816); **caixa pós-0180 none** | `grouping` (diagnose write clients=4 expected_group=4; WRITEPHASE avg_group~1.6 timed). 0180 P0.39 catch-up to 4 when 2–8 | RFC-0178 P1.3 / 0180 P0.39 / 0184 P1.1 |
