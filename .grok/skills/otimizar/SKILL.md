...
- Last fire: worked (51e0554 P0.78 write_buffer_for_ram). consecutive_noops=0
- Why: leftover 2M 4GiB-shaped Pedra 227k p50 16.1 (was 209k/17.4); Darwin 100k ratio=0.716 vs Rocks 229k collapsed-ish
- This fire MUST land: engine cut that moves ycsb_f_mc4 vs Rocks SYNC=0 (ratio=)
- Forbidden this fire: P0.72; P0.73; P0.76; grouping knobs; collapsed Rocks; Darwin as Linux; G1 1c win; kvrocks_set_mc50 "win"
- Deeper: ycsb_f is 50% get_probe + 50% rmw (get+put). Linux run2 0.766. Open rmw / contains / TLS last-get.
