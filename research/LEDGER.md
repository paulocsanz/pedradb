...
| L8 | Fold = LocalApplied, cursor após apply; **não** é voter | `SHIP` | ficha | R048, R096, R090 | RFC-0024; ficha R048 p. 2 — learner ≠ quorum |
...
| L28 | Swarm / buggify no DST do store (fidelidade FDB §4) | `MEASURE` | ficha | R043 | p. 8–9; já há `cluster_dst_*`. Gate: bug de cluster reproduzido por seed no sim |
