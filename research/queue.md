...
|------:|----|-------|---------|----------|
| 1 | R010 | RocksDB Experience (FAST'21) | incumbent we are measured against | usenix `fast21-dong.pdf` |
| 2 | R043 | FoundationDB (SIGMOD'21) | Montanha face + DST | `foundationdb.org/files/fdb-paper.pdf` |
| 3 | R044 | FDB Record Layer (SIGMOD'19) | databases *on* a TX KV | `foundationdb.org/files/record-layer-paper.pdf` |
| 4 | R045 | CockroachDB (SIGMOD'20) | SQL + Multi-Raft + Pebble | ACM / cockroachlabs PDF |
| 5 | R012 | LSM compaction design space (VLDB'21) | the four knobs | `vldb.org/pvldb/vol14/p2216-sarkar.pdf` |
| 6 | R041 | Percolator (OSDI'10) | **already local** — fichar only | `docs/references/percolator-osdi2010.pdf` |
| 7 | R005 | WiscKey (FAST'16) | **already local** — fichar; GC still open | `docs/references/wisckey-fast2016.pdf` |
| 8 | R006 | Monkey (SIGMOD'17) | **already local** — fichar vs shipped Bloom | `docs/references/monkey-sigmod2017.pdf` |
| 9 | R007 | Dostoevsky (SIGMOD'18) | **already local** — fichar the non-ship | `docs/references/dostoevsky-sigmod2018.pdf` |
| 10 | R048 | TiDB (VLDB'20) | **already local** — fichar learner vs fold | `docs/references/tidb-raft-htap-vldb2020.pdf` |

## Wave 1 — recent LSM we must not ignore

| Order | ID | Paper | Why now | PDF hint |
|------:|----|-------|---------|----------|
| 11 | R014 | Endure (VLDB'22) | robust tuning > point-optimal | `vldb.org/pvldb/vol15/p1605-huynh.pdf` |
| 12 | R013 | Spooky (VLDB'22) | granulated compact | PVLDB / `nivdayan.github.io/spooky.pdf` |
| 13 | R016 | ADOC (FAST'23) | stall = dataflow, not a new tree | usenix FAST'23 |
| 14 | R017 | SILK (ATC'19) | stall pacing | usenix ATC'19 |
