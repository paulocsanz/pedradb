...
pub use db::{
    ...
    CompactOptions, Db, DbStats, OpenOptions, PreparedL0Compact, ReadProbeSnap, ScanProjection,
    Snapshot, SnapshotPin, WriteOptions, CHECKPOINT_META_FILE, L0_COMPACTION_TRIGGER,
