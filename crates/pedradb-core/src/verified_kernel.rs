...
pub fn profile_report() -> &'static [ProfileComponent] {
    &[
        ...
        on!("write_op_range_end", "write_op_range_end", "range-deletion end bound (F30)"),
        ...
        // Public catalog pairs not previously claimed.
        on!("merge_sift", "merge_sift", "RFC-0187 P1.3 / RFC-0188 P0.2"),
        on!("wal_rotate_decision", "wal_rotate_decision", "RFC-0200 P0.2 close (try_rotate_wal step)"),
        on!("occ_snap_published", "occ_snap_published", "RFC-0045 P2.1 lock-order"),
        on!("rwlock_client_may_mutate", "rwlock_client_may_mutate", "RFC-0070 data-race client"),
        on!("changelog_durable_commit", "changelog_durable_commit", "RFC-0219 P0.1"),
        on!("wal_archive_delete", "wal_archive_delete", "RFC-0219 P0.2"),
        on!("bulk_manifest_persist", "bulk_manifest_persist", "RFC-0219 P0.3"),
        on!("point_cache_validity", "point_cache_validity", "RFC-0219 P1.1"),
        on!("point_tombstone", "point_tombstone", "RFC-0219 P1.1"),
        on!("dir_sync_plan", "dir_sync_plan", "RFC-0219 P1.1"),
        on!("fence_admission", "fence_admission", "RFC-0219 P1.2"),
        on!("fence_record", "fence_record", "RFC-0219 P1.2"),
        on!("group_batch_sync", "group_batch_sync", "RFC-0219 P1.2"),
        on!("pit_resync_rewrite_plan", "pit_resync_rewrite_plan", "RFC-0219 P1.4"),
        on!("parked_pair", "parked_pair", "RFC-0219 P1.3"),
        on!("auto_flush_gate", "auto_flush_gate", "RFC-0219 P1.3"),
        on!("mem_auto_flush", "mem_auto_flush", "RFC-0219 P1.3"),
        on!("manifest_publish_plan", "manifest_publish_plan", "RFC-0219 P1.4"),
        on!("changelog_store_plan", "changelog_store_plan", "RFC-0219 P1.4"),
        on!("parked_pop_plan", "parked_pop_plan", "RFC-0219 P2.1"),
        on!("group_ack_plan", "group_ack_plan", "RFC-0219 P2.1"),
        on!("occ_member_fate", "occ_member_fate", "RFC-0057 P2.1 caller"),
        on!("occ_batch_plan", "occ_batch_plan", "RFC-0057 P2.1 script"),
        on!("write_admission", "write_admission", "RFC-0170 P2.4"),
        on!("write_admit", "write_admit", "RFC-0170 P2.4"),
        on!("wal_sync_required", "wal_sync_required", "RFC-0171 P1.1"),
        on!("seq_exhausted", "seq_exhausted", "RFC-0171 P1.1"),
        on!("batch_is_empty", "batch_is_empty", "RFC-0171 P1.1"),
        on!("fence_on_sync_fail", "fence_on_sync_fail", "RFC-0171 P1.1"),
        on!("wal_commit_plan", "wal_commit_plan", "RFC-0171 P1.1 script"),
        on!("torn_head_empty_log", "torn_head_empty_log", "RFC-0171 P1.2"),
        on!("torn_tail_needs_cut", "torn_tail_needs_cut", "RFC-0171 P1.2"),
        on!("seq_after_feed", "seq_after_feed", "RFC-0171 P1.2"),
        on!("pit_resync_rewrite", "pit_resync_rewrite", "RFC-0171 P1.2"),
        on!("dir_sync_required", "dir_sync_required", "RFC-0171 P1.1"),
        on!("auto_flush_due", "auto_flush_due", "RFC-0170 P2.4"),
        on!("snap_empty", "snap_empty", "RFC-0174 P1.1"),
        on!("snap_below_watermark", "snap_below_watermark", "RFC-0174 P1.1"),
        on!("mem_point_decides", "mem_point_decides", "RFC-0174 P1.1"),
        on!("prefer_newer_seq", "prefer_newer_seq", "RFC-0174 P1.1"),
        on!("scale_probes", "scale_probes", "RFC-0176 P0"),
        on!("scale_warm", "scale_warm", "RFC-0176 P0"),
        on!("scale_probes_worst", "scale_probes_worst", "RFC-0176 P1"),
        on!("scale_predict", "scale_predict", "RFC-0176 P1"),
        on!("scale_happy_hot", "scale_happy_hot", "RFC-0176 P1"),
        on!("scale_forecast", "scale_forecast", "RFC-0176 P1.2"),
        on!("ops_pitr_window", "ops_pitr_window", "PITR restore_pitr filter"),
        on!("cf_flush_plan", "cf_flush_plan", "RFC-0219 P2.1"),
