...
/// RFC-0229 P1.1: true iff this thread is a registered PCT worker, so the
/// World/PCT harness owns the next write-group wake. Production without a
/// bound turnstile is an OS park.
#[must_use]
pub fn harness_owns_wait() -> bool {
