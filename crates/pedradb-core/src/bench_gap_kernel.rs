...
pub const BALANCE_SHAPES: [&str; 35] = [
...
mod tests {
    ...
    fn classify_probes_on_walk_all_is_not_ok() {
        ...
        assert_eq!(BALANCE_SHAPES.len(), 35);
        ...
        assert!(BALANCE_SHAPES.contains(&"qs_neg_lookup_mc4"));
        assert!(BALANCE_SHAPES.contains(&"qs_batch_write_mc4"));
        assert!(BALANCE_SHAPES.contains(&"rockset_hybrid_mc4"));
        ...
        assert!(BALANCE_SHAPES.contains(&"surreal_tx_get_mc4"));
        assert!(BALANCE_SHAPES.contains(&"oxigraph_spo_lookup_mc4"));
        assert!(BALANCE_SHAPES.contains(&"solana_trailing_read_mc4"));
        assert!(BALANCE_SHAPES.contains(&"kvrocks_scan_mc4"));
        assert!(BALANCE_SHAPES.contains(&"flink_window_state_mc4"));
        ...
        assert!(BALANCE_SHAPES.contains(&"nebula_insert_edge_mc4"));
        assert!(BALANCE_SHAPES.contains(&"solana_shred_append_mc4"));
        assert!(BALANCE_SHAPES.contains(&"arango_doc_crud_mc4"));
        assert!(BALANCE_SHAPES.contains(&"kvrocks_pipelined_set_mc4"));
        assert!(BALANCE_SHAPES.contains(&"rockstore_widecol_rw_mc4"));
        assert!(BALANCE_SHAPES.contains(&"kvrocks_blob_set_mc4"));
        assert!(BALANCE_SHAPES.contains(&"deps_lock_prewrite_mc4"));
    }
}
