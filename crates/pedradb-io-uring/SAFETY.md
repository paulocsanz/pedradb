...
RFC-0074 P2.1: `cqe_res_ok` is single-artifact — the kernel body rustc
links, paid by the Charon+Aeneas extract (`scripts/aeneas_cqe.sh`,
`CqeKernel.lean`); the `verus/cqe_res.rs` twin and its ghost block were
deleted 2026-09-09. P2.2: `cqe_ring_model_admitted` is always
